...
- [ ] Code is checked into the appropriate branch. 
- [ ] Code has been reviewed by at least one other team member. 
- [ ] Code review has been conducted by the tech lead to ensure quality and adherence to coding standards. 
- [ ] All feedback from the code review is addressed and closed by the developer. 
...
- [ ] Design debt is documented in Monday, as needed.  
- [ ] User story satisfies the defined Acceptance Criteria. 
- [ ] Required documentation for the user story is completed as per the acceptance criteria. 
- [ ] Architecture Decision Record (ADR) is updated, if needed  
- [ ] Performance Testing: User story undergoes load testing and meets the desired performance metrics. 
- [ ] Security Testing:
- [ ] Potential security vulnerabilities for the user story are identified and addressed as needed. 
- [ ] Secrets are correctly being stored in a Secrets Manager and not the codebase.
- [ ] In the event secrets have been committed to the codebase, they have been rotated.

## UX Items

### [UX Review and Accessibility Testing Guidelines ](https://ustaxcourt.sharepoint.com/:w:/r/sites/Website-adhoc/_layouts/15/Doc.aspx?action=default&file=UX+Review+and+Accessibility+Testing+Process+-+WebApp.docx&mobileredirect=true&sourcedoc={5123F94B-78B6-4407-A703-AFBE5B601432})
...
- [ ] Double check functionality, DoD items
- [ ] Release notes if needed
- [ ] High five everyone
- [ ] Story is formally accepted by the Product Owner. 
